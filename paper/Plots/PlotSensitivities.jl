...
data = CSV.File("MarineHydro.jl/paper/Plots/12_heuristics_dx_DELhommeau.csv") |> DataFrame
...
# Save the plot
savefig("/home/cornell/ForkMarineHydro/MarineHydro.jl/paper/Plots/12_heuristics_dx.pdf")
