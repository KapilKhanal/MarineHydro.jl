...
#       label = "MarineHydro", marker = :circle, linewidth = 2,linecolor = vermillion,markercolor = vermillion)
...
# savefig("/home/cornell/ForkMarineHydro/MarineHydro.jl/paper/Plots/HemisphereCoefficientComparison_damping.pdf")

# plot(K_heave,  results_amass, xlabel = "kr",ylabel = "A(kr)",
#      label = "MarineHydro", marker = :diamond, linewidth = 2,linecolor = vermillion,markercolor = vermillion)
...
# savefig("/home/cornell/ForkMarineHydro/MarineHydro.jl/paper/Plots/HemisphereCoefficientComparison_amass.pdf")
...
# savefig("/home/cornell/ForkMarineHydro/MarineHydro.jl/paper/Plots/Surge_HemisphereCoefficientComparison_damping.pdf")
...
# savefig("/home/cornell/ForkMarineHydro/MarineHydro.jl/paper/Plots/Surge_HemisphereCoefficientComparison_amass.pdf")
...
# cptmesh = cpt.mesh_sphere(radius=r, center=(0, 0, 0), resolution=(40, 40)).immersed_part()
...
# plot!(K_heave_diff, abs.(julia_diff_omega), marker=:square, label="MarineHydro", color=vermillion, linestyle=:solid)

# xlabel!("kr")
# ylabel!("Diffraction Force")
# plot!(legend=:topright, grid=true)

# savefig("/home/cornell/ForkMarineHydro/MarineHydro.jl/paper/Plots/diffraction_comparison.pdf")
...
# plot!(K_heave_diff, abs.(julia_froude_omega), marker=:square, label="MarineHydro", color=vermillion, linestyle=:solid)

# xlabel!("kr")
# ylabel!("Froude Krylov Force")
# plot!(legend=:topright, grid=true)
# savefig("/home/cornell/ForkMarineHydro/MarineHydro.jl/paper/Plots/froudeKrylov_comparison.pdf")
...
for (i, r) in enumerate(radii)
        grads = Zygote.gradient(X -> rankine_program(X[1], X[2]), [r, surge])[1][1]
...
plot(radii, _gradients , xlabel="r [m]", ylabel="∂A_∂r", label="MarineHydro(AD)",marker = "*",color = vermillion)
plot!(radii,analy_grady  , xlabel="r [m]", label="Analytical",marker = "*" , color = bluishgreen)
savefig("/home/cornell/ForkMarineHydro/MarineHydro.jl/paper/Plots/analy_ad_AMass_surge.pdf")
