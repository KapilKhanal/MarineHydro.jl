...
showb("analytic integral_gradient", mintime(() -> integral_gradient(VRankine(), (center=element_1_center,), element_2; with_respect_to_first_variable=true)))
showb("Zygote ∇∫ VRankine", mintime(() -> Zygote.gradient(c -> integral(VRankine(), (center=c,), element_2), element_1_center), 80))
showb("FD ∇∫ VRankine", mintime(() -> ForwardDiff.gradient(c -> integral(VRankine(), (center=c,), element_2), element_1_center), 80))
...
showb("Zygote J(∇∫) VRankine", mintime(() -> Zygote.jacobian(c -> collect(integral_gradient(VRankine(), (center=c,), element_2; with_respect_to_first_variable=true)), element_1_center), 40))
showb("FD J(∇∫) VRankine", mintime(() -> ForwardDiff.jacobian(c -> collect(integral_gradient(VRankine(), (center=c,), element_2; with_respect_to_first_variable=true)), element_1_center), 40))
